...
export default function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-96 bg-background shadow-2xl z-50 transition-transform duration-500 ease-out ${
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between p-6 border-b border-border/50">
            ...
            <button
              onClick={onClose}
              className="p-2 hover:bg-sage-100/50 rounded-full transition-all duration-300 hover:rotate-90"
            ...
            {items.length === 0 ? (
              ...
              <div className="space-y-4">
                {items.map((item, index) => (
                  <div
                    key={item.product.id}
                    className="flex gap-4 p-4 bg-sage-50/50 rounded-xl animate-in slide-in-from-right-8 fade-in duration-300"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <button
                          ...
                          className="p-1 hover:bg-sage-200/50 rounded transition-all duration-200 hover:scale-110"
                    ...
                    <button
                      ...
                      className="text-foreground/40 hover:text-destructive transition-colors duration-200"
