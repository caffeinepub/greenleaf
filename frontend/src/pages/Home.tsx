...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section
        ref={careTipsRef}
        className="py-16 px-4 sm:px-6 bg-sage-50 relative overflow-hidden"
      >
        <div
      ...
      <section ref={plantBenefitsRef} className="py-16 px-4 sm:px-6 bg-sage-50">
      ...
      >
        ...
        <div className="container mx-auto relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-sage-900 mb-12">
            Shop by Category
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      {/* Best Sellers */}
      <section ref={bestSellersRef} className="py-16 px-4 sm:px-6 bg-sage-50">
      ...
      {/* Benefits Section */}
      <section ref={benefitsRef} className="py-16 px-4 sm:px-6 bg-sage-50">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-foreground/70">
                Every plant is carefully selected for quality and health
              </p>
            </div>
            <div
      ...
      {/* Testimonials */}
      <section ref={testimonialsRef} className="py-16 px-4 sm:px-6 bg-sage-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-sage-900 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className={`glass p-8 rounded-2xl shadow-soft transition-all duration-700 hover:shadow-soft-lg ${
      ...
      {/* Newsletter Section */}
      <section className="pt-16 px-4 sm:px-6 bg-sage-50">
