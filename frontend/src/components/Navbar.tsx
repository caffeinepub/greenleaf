  ...
  return (
    <>
      ...
      >
        ...
        />
        <div
          className={`absolute top-0 right-0 h-full w-64 bg-sage-50 shadow-2xl transition-transform duration-500 border-l border-sage-200 ${
          ...
          <div className="flex flex-col p-6 pt-24 space-y-6">
            {navLinks.map((link) => (
              <Link
                ...
                to={link.to}
                onClick={() => setIsMobileMenuOpen(false)}
                className="text-lg font-medium text-sage-800 hover:text-sage-600 transition-colors duration-300"
                activeProps={{
